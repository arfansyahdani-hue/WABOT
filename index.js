...
//
const BotName = 'WHATSAPP BOT'; // Nama Bot Whatsapp
const Instragramlu= 'https://instagram.com/Arfdnii_'; // Nama Instagramlu cok
const whatsapplu = '085877075481'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/CnYQahGA5fD9fWOFZ8Nu1j'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/CnYQahGA5fD9fWOFZ8Nu1j; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Arfdnii`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Arfdnii`)
})
